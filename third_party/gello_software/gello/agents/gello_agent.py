...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    # # Ours UR5 Gello Configuration
    # "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAWBIN6-if00-port0": DynamixelRobotConfig(
    #     joint_ids=(1, 2, 3, 4, 5, 6),
    #     joint_offsets=(6.283, 4.712, 0.0, 3.142, 0.0, 0.0),
    #     joint_signs=(1, 1, -1, 1, 1, 1),
    #     gripper_config=(7, 199, 157),
    # ),
    # Ours UR5 Gello Configuration (updated for flipped UR)
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAWBIN6-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6),
        joint_offsets=(6.283, 1.571, 3.142, 0.000, 0.000, 0.000),
        joint_signs=(1, -1, 1, -1, 1, 1),
        gripper_config=(7, 199, 157),
    ),
}
